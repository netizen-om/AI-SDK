...
const AddNewButton = () => {
  ...
  const handleSubmit = async(data : {
    ...
    toast.success("Playgound created successfully")
    setIsModalOpen(false)
    router.push(`/playgound/${res?.id}`)
  }
  ...
  return (
    <>
      <div
        ...
        hover:bg-background hover:border-white hover:scale-[1.02]
      ...
      >
        <div className="flex flex-row justify-center items-start gap-4">
          <Button
            variant={"outline"}
            className="flex justify-center items-center bg-white group-hover:bg-[#fff8f8] group-hover:border-white group-hover:text-[#E93F3F] transition-colors duration-300"
            size={"icon"}
          >
