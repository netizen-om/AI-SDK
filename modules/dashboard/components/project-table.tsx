              ...
              <TableRow key={project.id}>
                <TableCell className="font-medium">
                  <div className="flex flex-col">
                    <Link href={`/playgound/${project.id}`} className="hover:underline">
                ...
                <TableCell>
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end" className="w-48">
                      ...
                      <DropdownMenuItem asChild>
                        <Link href={`/playgound/${project.id}`} className="flex items-center">
                          <Eye className="h-4 w-4 mr-2" />
                          Open Project
                        </Link>
                      </DropdownMenuItem>
                      <DropdownMenuItem asChild>
                        <Link href={`/playgound/${project.id}`} target="_blank" className="flex items-center">
