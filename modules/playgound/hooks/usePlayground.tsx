...
import {
  getPlaygroundById,
  SaveUpdatedCode,
} from "@/modules/playgound/actions";
import type { TemplateFolder } from "@/modules/playgound/lib/path-to-json";
  ...
  const loadPlayground = useCallback(async () => {
    ...
    try {
      ...
      if (typeof rawContent === "string") {
        ...
        setTemplateData(parsedRawContent);
        toast.success("Playgound loaded sucessfully");
        return;
      }
